...
const page = () => {
  ...
  return (
    <div>
      ...
      <EmailShareButton className="m-1" url={userLink} body="I wanted to share some exciting news with you—I've recently signed up for a fantastic new travel-sharing service called Wanderlog. It's a platform where you can document your travels, share recommendations, and connect with fellow adventurers.

If you're interested, you can sign up for Wanderlog using the following link: https://wanderlogfront.vercel.app . Once you're all set up, we can start sharing our travel adventures and exploring new destinations together!

Looking forward to seeing you on Wanderlog!">
